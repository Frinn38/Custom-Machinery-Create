...
public class Registration {
    ...
    public static final Supplier<MachineComponentType<BlazeBurnerComponent>>        BLAZE_BURNER_MACHINE_COMPONENT = MACHINE_COMPONENTS.register("blaze_burner", () -> MachineComponentType.create(BlazeBurnerComponent::new));
    ...
    public static final Supplier<RequirementType<BlazeBurnerRequirement>> BLAZE_BURNER_REQUIREMENT = REQUIREMENTS.register("blaze_burner", () -> RequirementType.world(BlazeBurnerRequirement.CODEC));
